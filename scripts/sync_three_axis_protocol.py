...
SOURCE = ROOT / "shared" / "three-axis-protocol.md"
CONSUMERS = (
    "ljh",
    "ljh-brief",
    "ljh-changjing",
...
TARGET_NAME = "three-axis-protocol.md"
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="同步 LJHskill 三轴状态协议")
    ...
    print(f"{action}完成：{len(CONSUMERS)} 个 Skill 的三轴协议与真源一致")
    return 0
